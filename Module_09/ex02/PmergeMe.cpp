...
/*   Updated: 2024/08/21 14:41:03 by bat              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
PmergeMe::PmergeMe(int ac, char **av) {
    // Fill the containers with integers from command line arguments
    ...
    clock_t end3 = clock();
    double time3 = static_cast<double>(end3 - start3) / CLOCKS_PER_SEC * 1000000; // Microsecondes

    std::cout << "After: ";
    display(inputDeque);
    std::cout << "Time to process a range of " << inputDeque.size() << " elements with std::deque container: " << time1 << " µs" << std::endl;
    std::cout << "Time to process a range of " << inputList.size() << " elements with std::list container: " << time2 << " µs" << std::endl;
    std::cout << "Time to process a range of " << inputVector.size() << " elements with std::vector container: " << time3 << " µs" << std::endl;
